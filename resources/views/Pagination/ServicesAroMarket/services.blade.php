...
<div class="bannerService mb-4">
    <div class="container">
        ...
        <div class="opportinuty">
            <p><i class="fa fa-check-circle marked"></i> Produits de qualité supérieur</p>
            <p><i class="fa fa-check-circle marked"></i> Avec garantie</p>
            <p><i class="fa fa-check-circle marked"></i> Livraison possible</p>
            <p><i class="fa fa-check-circle marked"></i> Service apres vente assurée</p>
        </div>
        <div>
