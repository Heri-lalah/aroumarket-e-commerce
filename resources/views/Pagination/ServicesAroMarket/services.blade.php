...
<div class="bannerService mb-4 mt-3">
    <div class="container">
        <div class="intro text-center">
            <p><img src="{{asset('/storage/avatars/logo.png')}}" alt="logo" width="100px"></p>
            ...
            <div class="payement text-center">
                ...
                <div class="mobileMoney mt-5 mx-md-5">
                    ...
                    <picture class="row justify-content-center">
                        <img class="animate__animated animate__flip col rounded rounded-circle mobileMoney" src="{{asset('/storage/assets/services/Mvola.jpg')}}" alt="mobileMoney">
                        <img class="animate__animated animate__flip col rounded rounded-circle mobileMoney" src="{{asset('/storage/assets/services/AirtelMoney.jpg')}}" alt="mobileMoney">
                        <img class="animate__animated animate__flip col rounded rounded-circle mobileMoney" src="{{asset('/storage/assets/services/OrangeMoney.jpg')}}" alt="mobileMoney">
                    </picture>
                </div>
                <div class="bank mt-md-5">
                    <p class="titleitem">Virement bancaire :</p>
                    <picture>
                        <img class="boa animate__animated animate__zoomIn" src="{{asset('/storage/assets/services/BOA.png')}}" alt="boa">
                        <img class="animate__animated animate__zoomIn" src="{{asset('/storage/assets/services/mastercard.png')}}" alt="mastercard">
                    </picture>
                </div>
            </div>
        </div>
